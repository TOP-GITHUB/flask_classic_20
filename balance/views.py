...
def nuevo():
    ...
    '''
    Validar formulario:
    - Si la vlidacion es OK -> insetar registro en tabla y redireccionar a /
    - Si la validacion es erronea -> devolcer el formulario y render_template y 
        preparar nuestra platilla para gestionar los errores
    '''
